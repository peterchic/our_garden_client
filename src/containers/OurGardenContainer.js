...
import { editUser, getFarmers, getProducts, getUsers, getFarmerProducts, addToCart, editCart, createReview, getReviews } from '../api/RailsAPI'
    ...
    return (
      <div>
        ...
        <GardenPage
          ...
          handleReview={this.handleReview.bind(this)} reviews={this.state.reviews}/>
      </div>
    )
  }
}
